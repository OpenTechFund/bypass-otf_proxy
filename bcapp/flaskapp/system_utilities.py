...
def get_configs():
    ...
    configs = {
        ...
        'azure_storage_account': config.get('AZURE', 'storage_account_name'),
        'azure_storage_key':config.get('AZURE', 'storage_key'),
        'azure_storage_conn_string': config.get('AZURE', 'storage_connection_string'),
